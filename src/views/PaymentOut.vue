          ...
          <div class="modal-body">
            ...
            <div v-if="activeFormTab === 'header'">
              <div class="form-grid-3">
                ...
                <div class="form-group form-group--full">
                  <label>Pay To (Vendor) <span class="req">*</span></label>
                  <div class="acc-wrap">
                    <input
                ...
                <div class="form-group">
                  <label>Paid From <span class="req">*</span></label>
              ...
              <div v-if="!isEdit && !savedPaymentId" class="info-box info-box--blue" style="margin-top:16px">
                ...
                Simpan header terlebih dahulu, lalu buka tab <strong>Detail / Add Invoice</strong> untuk menambahkan invoice vendor.
              </div>
              <div v-if="savedPaymentId && !isEdit" class="info-box info-box--green" style="margin-top:16px">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>
                Header tersimpan. Buka tab <strong>Detail / Add Invoice</strong> untuk melanjutkan pembayaran invoice vendor.
              </div>
            </div>
            ...
            <div v-if="activeFormTab === 'detail'">
              ...
              <div class="pay-detail-summary">
                ...
                <div class="pay-ds-item">
                  <span class="pay-ds-label">Pay To</span>
                ...
                <div class="pay-ds-item">
                  <span class="pay-ds-label">Paid From</span>
          ...
          <div class="modal-body" v-if="viewRow">
            ...
            <div v-if="viewTab === 'lines'">
              ...
              <div v-else class="table-wrap" style="margin-bottom:0">
                <table class="table">
                  ...
                  <tbody>
                    <tr v-if="viewLines.length === 0"><td colspan="7" class="td-empty">No data in grid.</td></tr>
            ...
            <div v-if="viewTab === 'header'">
              <div class="detail-grid" style="margin-top:8px">
                ...
                <div class="detail-item"><span class="detail-label">Pay To (Vendor)</span><span class="detail-value">{{ bpName(viewRow) }}</span></div>
                ...
                <div class="detail-item"><span class="detail-label">Paid From</span><span class="detail-value">{{ parseIdentifier(viewRow['account$_identifier']) }}</span></div>
